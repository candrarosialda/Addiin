...
<head>
    ...
    <title>Portal - AdDiin</title>
    <link href="../portal/css/media_query.css" rel="stylesheet" type="text/css"/>
    ...
    <link href="../portal/css/owl.carousel.css" rel="stylesheet" type="text/css"/>
    <link href="../portal/css/owl.theme.default.css" rel="stylesheet" type="text/css"/>
    <!-- Bootstrap CSS -->
    <link href="../portal/css/style_1.css" rel="stylesheet" type="text/css"/>
    <!-- Modernizr JS -->
    <script src="../portal/js/modernizr-3.5.0.min.js"></script>
</head>
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 fh5co_mediya_center"><a href="#" class="color_fff fh5co_mediya_setting"><i
                    class="fa fa-clock-o"></i>&nbsp;&nbsp;&nbsp;Selasa, 15 Maret 2022</a>
                <div class="d-inline-block fh5co_trading_posotion_relative"><a href="../koneksi/proses_logout.php" class="treding_btn">Keluar</a>
                    <div class="fh5co_treding_position_absolute"></div>
                </div>
                <a href="../pendaftaran/html/form-layouts-vertical.html" class="color_fff fh5co_mediya_setting">Penerimaan Mahasiswa Baru Universitas KH. Abdul Wahab Hasbullah, Tambakberas</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-3 fh5co_padding_menu">
                <img src="../assets/img/logo.png" alt="img" class="fh5co_logo_width"/>
            </div>
        ...
        <nav class="navbar navbar-toggleable-md navbar-light ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="single.html">Terkini <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdownMenuButton2" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">Konten <span class="sr-only">(current)</span></a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdownMenuButton3" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">Komunitas<span class="sr-only">(current)</span></a>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink_1">
                            <a class="dropdown-item" href="#">Ad - Diin</a>
                            <a class="dropdown-item" href="#">Bahrul Ulum, Tambakberas</a>
                            <a class="dropdown-item" href="#">Lembaga Pendidikan</a>
                        </div>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="Contact_us.html">Kontak <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="row mx-0">
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="fh5co_tags_all">
                    ...
                    <a href="#" class="fh5co_tagg"> Pendaftaran Sekolah</a>
                    <a href="#" class="fh5co_tagg"> PMB</a>
                    <a href="#" class="fh5co_tagg"> Seputar Santri</a>
                    <a href="#" class="fh5co_tagg"> Fiqih</a>
                    <a href="#" class="fh5co_tagg"> Ekonomi Syariah</a>
                    <a href="#" class="fh5co_tagg"> Kegiatan Pondok</a>
                    <a href="#" class="fh5co_tagg"> Hafalan</a>
                    <a href="#" class="fh5co_tagg"> NU</a>
                </div>
                <div>
...
<div class="container-fluid fh5co_footer_bg pb-3">
    <div class="container animate-box">
        <div class="row">
            <div class="col-12 spdp_right py-5"><img src="../assets/img/logo.png" alt="img" class="footer_logo"/></div>
            <div class="clearfix"></div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="footer_main_title py-3"> Tentang Portal Ad - Diin, Bahrul Ulum, Tambakberas</div>
                <div class="footer_sub_about pb-3"> Portal Tentang Portal Ad - Diin, Bahrul Ulum, Tambakberas, Menyediakan berita terkini
                    seputar PP Ad - Diin, Bahrul Ulum, Tambakberas, Pendaftaran Sekolah, Berita Lokal hingga Nasional, NU
                    Konten Menarik hingga Sejarah
                </div>
            ...
            <div class="col-12 col-md-3 col-lg-2">
                ...
                <ul class="footer_menu">
                    <a href="#" class="fh5co_tagg"> Pendaftaran Sekolah</a></li>
                    <a href="#" class="fh5co_tagg"> PMB</a></li>
                    <a href="#" class="fh5co_tagg"> Seputar Santri</a></li>
                    <a href="#" class="fh5co_tagg"> Fiqih</a></li>
                    <a href="#" class="fh5co_tagg"> Ekonomi Syariah</a></li>
                    <a href="#" class="fh5co_tagg"> Kegiatan Pondok</a></li>
                    <a href="#" class="fh5co_tagg"> Hafalan</a></li>
                    <a href="#" class="fh5co_tagg"> NU</a></li>
                </ul>
            </div>
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                <div class="footer_main_title py-3"> Paling Sering Dilihat</div>
                <div class="footer_makes_sub_font"> Maret 15, 2022</div>
...
<div class="container-fluid fh5co_footer_right_reserved">
    <div class="container">
        <div class="row  ">
            <div class="col-12 col-md-6 py-4 Reserved"> © Copyright 2022, All rights reserved. Design by <a href="https://freehtml5.co" title="Trilogy Techno Expert">Trilogy Techno Expert</a>. </div>
...
<div class="buy-now">
    <a
      href="../pendaftaran/html/form-layouts-vertical.html"
      target="_blank"
